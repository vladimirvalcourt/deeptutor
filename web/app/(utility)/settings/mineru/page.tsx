...
export default function MinerUSettingsPage() {
  ...
  return (
    <div>
      <SettingsPageHeader
        title={t("MinerU PDF")}
        description={t(
          "PDF parsing backend used when generating questions from an uploaded exam paper. Run MinerU locally, or use the hosted mineru.net cloud API.",
        )}
      />
        ...
        <>
          ...
          {!isCloud && (
            <SettingSection
              ...
              description={t(
                "Local parsing needs ~1-2 GB of model weights. They download lazily on the first parse, or download them ahead of time here.",
              )}
            >
              <SettingRow
