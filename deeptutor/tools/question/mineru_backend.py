...
path. Backend selection comes from ``mineru.json`` via
...
from deeptutor.tools.question.mineru_config import (
    MinerUConfig,
    MinerUError,
...
# PATH-lookup order matches ``check_mineru_installed`` in pdf_parser.py so the
...
def parse_pdf_to_workdir(
    ...
    *,
    ...
    if cfg.is_cloud:
        from deeptutor.tools.question.mineru_cloud import parse_cloud
...
def _parse_local(
    ...
    *,
    ...
    from deeptutor.tools.question.mineru_models import model_env_overrides
